 ...
 * @author hendri
 */
public class EMAlgorithm extends JApplet implements ActionListener, ItemListener {
        ...
        public void run() {
            ...
            for (int iterationNumber = 0;; iterationNumber++) {
                ...
                if (m_Cost > oldCost) {
                    ...
                    // Converged
                    System.out.println("Converged: " + ((oldCost - m_Cost) / (oldCost + m_Cost) * 2));
                    System.out.println("oldCost: " + oldCost);
                    System.out.println("m_Cost: " + m_Cost);
                    m_StopRequested = true;
                }
...
//        m_Contrast = (String) m_Contrasts.get(imageNumber);
        ...
        //for ( int i=0; i < m_NumberOfPixels; i++ )
        //  {
        //  System.out.println( i + ": " + m_PixelData[ i ] );
        //  }
        ...
        System.out.println("m_Minimum: " + m_Minimum);
        System.out.println("m_Maximum: " + m_Maximum);
        ...
        //for ( int j=0; j < m_NumberOfBins; j++ )
        //  {
        //  System.out.println( j +": " + m_Histogram[ j ] );
        //  }
        ...
        //System.out.println( "NumberOfPVClasses: " + m_NumberOfPVClasses );
    ...
    public void SetUpGUI() {
        ...
        //System.out.println( "" + m_DownsamplingFactor );
...
//            open it
//            m_ImageChoice.add((String) m_Descriptions.get(i));  open it
        }
...
//        add(m_ImageChoice);
    ...
    public void DrawPlot(Graphics g) {
        ...
        for (int classNumber1 = 0; classNumber1 < m_NumberOfClasses; classNumber1++) {
            for (int classNumber2 = classNumber1 + 1; classNumber2 < m_NumberOfClasses; classNumber2++) {
                ...
                //System.out.println( "pvClassNumber: " + pvClassNumber );
            ...
            for (int classNumber2 = classNumber1 + 1; classNumber2 < m_NumberOfClasses; classNumber2++) {
                ...
                for (int gaussianNumber = 0; gaussianNumber < m_NumberOfGaussiansPerPV; gaussianNumber++) {
                    ...
                    for (int i = m_Minimum; i < (m_Maximum + 1); i++) {
                        ...
                        //System.out.println( "weight for intensity " + i + " for gaussianNumber " + gaussianNumber + 
    ...
    public void SetInitialParametersToDefault() {
        ...
        //System.out.println( "m_NumberOfGaussiansPerPV: " + m_NumberOfGaussiansPerPV );
        ...
        System.out.println("Adjusting for contrast " + m_Contrast);
